...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO products (category_id, name, description, price, discount, image, stock, stock_status, status, is_new) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("issdisisii", $category_id, $name, $description, $price, $discount, $image, $stock, $stock_status, $status, $is_new);
    
    if ($stmt->execute()) {
        logActivity($conn, 'add_product', "Thêm sản phẩm: $name");
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" required class="form-control" min="0" step="1000">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" name="discount" value="0" class="form-control" min="0" max="100">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="image" required class="form-control" placeholder="assets/images/product.jpg">
                            <small>Nhập đường dẫn ảnh (ví dụ: assets/images/gundam-1.jpg)</small>
                        </div>
